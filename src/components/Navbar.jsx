      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-6 space-x-reverse">
            ...
            <Link to="/events" className="text-gray-700 hover:text-primary">الفعاليات</Link>
          ...
          <div className="flex items-center space-x-4 space-x-reverse">
            <a 
              ...
              className="bg-[#25D366] text-white px-4 py-2 rounded-lg hover:bg-opacity-90 transition-all duration-300 flex items-center"
            >
